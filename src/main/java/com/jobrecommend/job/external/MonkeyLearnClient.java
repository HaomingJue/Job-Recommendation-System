...
import com.jobrecommend.job.entity.ExtractRequestBody;
import com.jobrecommend.job.entity.ExtractResponseItem;
import com.jobrecommend.job.entity.Extraction;
...
public class MonkeyLearnClient {
    ...
    private static final String AUTH_TOKEN = "2529caffbbc1c07721ac1dc009670286820771b6";
    ...
    public List<Set<String>> extract(List<String> articles) {
        ...
        ResponseHandler<List<Set<String>>> responseHandler = response -> {
            ...
            ExtractResponseItem[] results =
                    mapper.readValue(entity.getContent(), ExtractResponseItem[].class);
